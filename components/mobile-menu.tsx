      ...
      >
        <ul className="bg-gray-800 px-4 py-2">
          <li>
            <Link
              href="/docs"
              className="font-medium w-full inline-flex items-center justify-center border border-transparent px-4 py-2 my-2 rounded-sm text-white bg-indigo-500 hover:bg-indigo-600 transition duration-150 ease-in-out"
